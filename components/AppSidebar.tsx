...
export function AppSidebar() {
	...
	return (
		<Sidebar
			collapsible="icon"
			className="min-w-[4rem] transition-all duration-300 ease-in-out"
		>
			<SidebarHeader className="p-6 border-b">
				<div className="flex">
					<SidebarTrigger />
					<div className="pl-2 font-bold text-xl whitespace-nowrap overflow-hidden transition-all duration-300">
						nocall.ai
					</div>
				</div>
			</SidebarHeader>
						...
						<SidebarMenuItem key={item.href}>
							...
							>
								<Link href={item.href}>
									...
									<span className="ml-1 whitespace-nowrap transition-opacity duration-300">
										{item.name}
									</span>
								</Link>
							</SidebarMenuButton>
			...
			<SidebarFooter className="p-5 border-t">
				<div className="flex justify-between items-center">
					<span className="text-sm text-muted-foreground whitespace-nowrap overflow-hidden transition-all duration-300">
						© 2025 AI管理
					</span>
