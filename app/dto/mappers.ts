...
import { Customer, type CustomerVariable } from "../models/Customer";
import type { CallDTO, CustomerDTO, CustomerVariableDTO } from "./types";
 ...
 */
export function toCustomerVariableDTO(
